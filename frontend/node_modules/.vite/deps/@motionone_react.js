...
// ../../node_modules/@motionone/react/dist/component.es.js
...
// ../../node_modules/@motionone/react/dist/context.es.js
var import_react = __toESM(require_react());
var MotionContext = (0, import_react.createContext)(void 0);

// ../../node_modules/@motionone/react/dist/utils/events.es.js
var import_react2 = __toESM(require_react());
function addDomEvent(target, eventName, handler, options) {
  target.addEventListener(eventName, handler, options);
  return () => target.removeEventListener(eventName, handler, options);
}
var domEventName = (propName) => propName.replace("on", "").toLowerCase();
...
function createMotionComponent(Component) {
  function Motion(_a, externalRef) {
    ...
    const state = createMotionState(options, (0, import_react3.useContext)(MotionContext));
    const initialStyle = (0, import_react3.useMemo)(() => createStyles(state.getTarget()), []);
    const ref = externalRef || (0, import_react3.useRef)(null);
    (0, import_react3.useEffect)(() => state.mount(ref.current), []);
    (0, import_react3.useEffect)(() => state.update(options));
    useEvents(ref, {
      onMotionStart,
      onMotionComplete,
      onHoverStart,
    ...
    const element = (0, import_react3.createElement)(Component, Object.assign(Object.assign({}, props), { ref, style: Object.assign(Object.assign({}, style2), initialStyle) }));
    return React.createElement(MotionContext.Provider, { value: state }, element);
  }
  return (0, import_react3.forwardRef)(Motion);
}

// ../../node_modules/@motionone/react/dist/index.es.js
...
//# sourceMappingURL=@motionone_react.js.map
